...
- Create task-lane implementation runs, gate-lane validation runs, and ship-prep gate evidence runs when triggered by UI workflows.
- Keep user-facing graph readable: scoped, non-overlapping runs with concise requests.
